...
const Gallery = () => {
  const galleryItems = [
    ...
    },
    {
      ...
      category: "Academic",
      description:
        "Innovative projects and experiments by our young scientists",
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {galleryItems.map((item, index) => (
            <Card
              key={index}
              className="bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 animate-slide-up"
            >
