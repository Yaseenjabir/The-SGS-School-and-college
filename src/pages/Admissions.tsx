...
const Admissions = () => {
  ...
  const documents = [
    ...
    "Student's Recent Passport-Size Photographs (4 Copies)",
    "Medical Certificate",
    "Character Certificate",
    "Admission Fee / Registration Fee Receipt",
    "Domicile (FSc Only)",
  ];
        ...
        <AnimatedSection animation="fade-in">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Join our vibrant learning community! We welcome students from
              Nursery to 12th grade who are eager to learn, grow, and make a
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Maximum 30 students per class ensuring personalized attention
                  for every child.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 leading-relaxed">
                  From Playgroup to FSc, we offer comprehensive education for
                  all age groups.
                </p>
              </CardContent>
            </Card>
                    ...
                    <div className="flex items-start space-x-3 mb-4">
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-gray-700 space-y-2">
                          ...
                          <li>
                            • International students need additional visa
                            documentation
                          </li>
                          <li>
                            • Transfer students require academic transcripts
                          </li>
                          <li>
                            • Documents in foreign languages need certified
                            translations
                          </li>
                        </ul>
                      </div>
